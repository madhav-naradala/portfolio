...
import SecretTrigger from '@/components/cave/secret-trigger';
import {
    ResumeHeader,
    ExperienceSection,
    SkillsSection,
    ...
    return (
        ...
        >
            ...
            <div className="relative z-10">
                ...
                >
                    <div className="apple-container grid grid-cols-[1fr_auto_1fr] items-center gap-6 text-sm text-white/40">
