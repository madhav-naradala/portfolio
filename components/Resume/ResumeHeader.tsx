...
export const ResumeHeader: React.FC<ResumeHeaderProps> = ({ personal }) => {
  ...
  return (
    <motion.div
      className="mb-12 bg-gradient-to-r from-primary via-secondary to-primary rounded-lg p-8 border border-accent/20"
      variants={containerVariants}
      initial="hidden"
      animate="visible"
    >
      <motion.h1 className="text-4xl md:text-5xl font-bold mb-2 text-white" variants={itemVariants}>
        {personal.name}
      </motion.h1>

      <motion.p className="text-accent-light text-lg mb-6 leading-relaxed" variants={itemVariants}>
        {personal.summary}
      </motion.p>
